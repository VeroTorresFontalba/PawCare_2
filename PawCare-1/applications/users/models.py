...
class Cronograma(models.Model):
    ...
    #  horas=models.ManyToManyField(Hora,related_name='horas',verbose_name='Horas a seleccionar')
     ...
     def __str__(self):
        return str(self.fechaReserva) + " - " +str(self.id)+"-"+str(self.user) + " - " +str(self.horas)+ " - " +str(self.estado)
...
class ReservaCliente(models.Model):
    ...
    def __str__(self):
        return  "id reserva:"+str(self.id)+"                    id cronograma:"+str(self.idCronograma)
